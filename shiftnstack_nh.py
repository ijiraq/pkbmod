...
parser.add_argument('date', default = '20240612')
parser.add_argument('chip', default = '24')
parser.add_argument('--dontUseNegativeWell', default = False, action='store_true')
parser.add_argument('--saves_path', default = '/arc/projects/NewHorizons/wesmod_results', help='Path to save the results.txt and input.pars files to. Default=%(default)s. if --rt is used, wesmod will be replaced with rtwesmod')
